...
namespace SOHTrainModel.Route
{
    public class TrainRoute : IEnumerable<TrainRouteEntry>
    {
        public TrainRoute()
        {
            Entries = new List<TrainRouteEntry>();
        }
        ...
        /// </summary>
        /// <returns>A <code>TrainRoute</code> that defines a route that starts at the original end station and finishes
        /// at the original start station.</returns>
