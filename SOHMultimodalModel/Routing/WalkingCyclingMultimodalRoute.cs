...
namespace SOHMultimodalModel.Routing
{
    internal class WalkingCyclingMultimodalRoute : MultimodalRoute
    {
        ...
        public WalkingCyclingMultimodalRoute(SpatialGraphMediatorLayer envLayer, IBicycleRentalLayer bicycleRentalLayer,
            Position start, Position goal)
        {
            ...
            var startRentalStreetNode =
                env.NearestNode(startRentalSidewalkNode.Position, SpatialModalityType.Cycling);
