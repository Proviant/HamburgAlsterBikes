...
namespace SOHMultimodalModel.Routing
{
    public class WalkingDrivingMultimodalRoute : MultimodalRoute
    {
        ...
        public WalkingDrivingMultimodalRoute(ISpatialGraphLayer envLayer, Car car, Position start, Position goal)
        {
        ...
        public WalkingDrivingMultimodalRoute(SpatialGraphMediatorLayer environmentLayer, Car car, Position goal)
        {
