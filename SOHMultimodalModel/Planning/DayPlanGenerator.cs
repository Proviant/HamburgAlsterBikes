...
namespace SOHMultimodalModel.Planning
{
    ...
    public static class DayPlanGenerator
    {
        ...
        /// <param name="isPartTimeWorker">Indicates whether the agent is full or part-time worker (working mostly until the afternoon)</param>
            ...
            IDictionary<TripReason, DateTime> appointments = null)
        {
            ...
            if (isWorker)
            {
                if (isPartTimeWorker)
                {
                    ...
                    {
                        actionWithStartTimes.Add(tempList.ElementAt(i));
                    }
