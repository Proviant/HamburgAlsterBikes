...
namespace SOHTests.MultimodalModelTests.RoutingTests
{
    public class MultimodalRouteTests
    {
        ...
        [Fact]
        public void EmptyRouteHasNoTravelTime()
        {
            var multimodalRoute = new MultimodalRoute();
            Assert.Equal(0, multimodalRoute.ExpectedTravelTime());
        }
        ...
        public void FindMainModalType()
        {
            ...
            {
                { route1, ModalChoice.Walking }, { route2, ModalChoice.CyclingRentalBike },
                { route2, ModalChoice.Walking }
            };
