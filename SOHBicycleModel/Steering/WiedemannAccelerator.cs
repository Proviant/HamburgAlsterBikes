...
*/
        ...
        private double CalcMaxAcceleration(double power, double velocity, double maxSpeed)
        {
            ...
            var currentMaxAccelerationFactor =
                new FastGaussianDistributionD(MaxAccelerationFactor, 0.3D).Next(RandomHelper.Random);
        ...
        public class WiedemannAcceleratorParameters
        {
            ...
            public double AheadAcceleration { get; set; }
