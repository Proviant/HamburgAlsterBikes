...
namespace SOHBicycleModel.Parking
{
    public class BicycleParkingLayer : VectorLayer<BicycleParkingLot>, IBicycleParkingLayer
    {
        ...
        public Bicycle CreateOwnBicycleNear(Position position, double radius, double useBikeAndRideParkingPercentage,
            string keyAttribute = "type", string type = "city")
        {
            var bicycle = EntityManager.Create<Bicycle>(keyAttribute, type);
