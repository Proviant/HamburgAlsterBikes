...
namespace SOHFerryModel.Model
{
    public class FerryDriver : AbstractAgent, IFerrySteeringCapable
    {
        ...
        private bool FindNextRoute()
        {
            ...
            var source = Environment.NearestNode(FerryRouteEnumerator.Current?.From.Position,
                SpatialModalityType.ShipDriving);
            var target = Environment.NearestNode(FerryRouteEnumerator.Current?.To.Position,
                SpatialModalityType.ShipDriving);
