...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{testing-velocity-after-stopping}~\caption{Konsolenausgabe, bei der \code{HumantTraveler} nach 5 Sekunden warten an einer \code{TrafficLight} ihre Geschwindigkeit ausgeben.}
